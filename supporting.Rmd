...
**Table S7** Data checks implemented in the first level of data quality control
(QC1).
...
**Figure S2.** Structure of sfn_data objects, which are based on the S4 class. Boxes in the figure 
represent different slots where data are stored.
...
labelled by dataset number in Table S4.
