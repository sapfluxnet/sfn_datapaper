...
'plant_md' depends on the number of trees in the dataset. More information on
...
**Table S5.** Number of trees per species in the SAPFLUXNET database.

**Table S6.** Number of trees per genus in the SAPFLUXNET database.
...
data.frame(sfn_species_ntrees_reduced[1:58,],
  ...
  flextable::set_caption('Table S5. Number of trees per species in the SAPFLUXNET database')
...
data.frame(sfn_genus_ntrees[1:32,],
  ...
  italic(j=c(1,3,5)) %>% 
  height(height=.2) %>% 
 flextable::set_caption('Table S6. Number of trees per genus in the SAPFLUXNET database')
