...
**Figure S2.** Structure of sfn_data objects, which are based on the S4 class
...
'plant_md' depends on the number of plants in the dataset. More information on
...
**Figure S3.** Screenshot of the app used for handling outliers and out of range values
...
**Table S5.** Number of plants per species in the SAPFLUXNET database.

**Table S6.** Number of plants per genus in the SAPFLUXNET database.
