...
### Figure 4. Sap flow methods and measurement level.

### Table 1. Calibrations

### Table 2. Whole-plant integration of sap flow data.

### Figure 5. Site and plant level attributes
- TODO: add titles to labels a) stand, b) plant, gymno/angio.

### Figure 6. Datasets duration and period
...
```
Figure 3. Taxonomic distribution of genera and species in SAPFLUXNET, showing (a) genera with > 50 trees and (b) species with > 30 trees in the database.
...
Figure 5. Plant and stand attributes
