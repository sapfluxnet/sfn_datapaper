...
**Table 2.** Number of trees using different radial and azimuthal integration approaches
for the different sap flow methods: cycling heat dissipation (CHD), compensation heat pulse (CHP),
heat dissipatio (HD), heat field deformation (HFD), heat pulse T-max (HPTM), heat ratio (HR), 
stem heat balance (SHB),trunk sector heat balance (TSHB).
...
on top of each bar depict the total number of trees for a given dataset. Empty bars show 
