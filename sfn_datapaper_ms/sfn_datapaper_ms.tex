...
\title{Template for preparing your manuscript submission to Copernicus journals
using RMarkdown}
...
\affil[1]{Institute for Geoinformatics, University of Münster, 48149 Münster,
Germany}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontribution{Daniel wrote the package. Josiah thought about poterry. Markus filled in
for a second author.} %% optional section
